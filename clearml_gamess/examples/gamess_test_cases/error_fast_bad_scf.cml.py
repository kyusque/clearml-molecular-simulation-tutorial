...
PIPELINE_NAME = "error_fast_bad_scf.cml_pipeline_gamess"
PIPELINE_VERSION = "0.1.0"
RUN_TASK_NAME = "error_fast_bad_scf.cml_task_run_gamess"
TRACK_TASK_NAME = "error_fast_bad_scf.cml_task_track_gamess"
...
INPUT = Path("clearml_gamess/examples/gamess_test_cases/error_fast_bad_scf.inp")
...
def main() -> None:
    ...
    args = argparse.Namespace(
        ...
        controller_entry_point="error_fast_bad_scf.cml.py",
